...
from .forms import PostCreateUpdateForm, CommentCreateForm, CommentReplyFrom, PostSearchForm
...
class PostDetailView(View):
    ...
    form_class_reply = CommentReplyFrom
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, "Post Created :D", "success")
            return redirect("home:post_detail", new_post.id, new_post.slug)


class PostAddReplyView(LoginRequiredMixin, View):
    form_class = CommentReplyFrom
...
class PostLikeView(LoginRequiredMixin, View):
    def get(self, request, post_id):
        ...
        if like.exists():
            messages.error(request, "You have liked this post before!", "danger")
        else:
